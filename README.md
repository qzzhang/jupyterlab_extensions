...
The first jupyterlab extension serving as a learning project.
...
# Change directory to the firstextension directory
...
folder is located. Then you can remove the symlink named `firstextension` within that folder.
